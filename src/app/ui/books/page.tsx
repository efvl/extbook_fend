              ...
              <tr key={book.id} className="hover:bg-gray-50 transition-colors">
                ...
                <Td align="right">
                  <div className="flex justify-end items-center gap-3">
                    {/* NEW: Action to open the Reader View starting at Page 1 */}
                    <Link 
                      href={`/ui/books/${book.id}/reader/1`} 
                    ...
                    <Link href={`/ui/words?bookId=${book.id}`} 
                    ...
                    <span className="text-gray-200">|</span>
                    {/* NEW: Bulk Import Link */}
                    <Link 
                      href={`/ui/books/${book.id}/import`}
                    ...
                    <span className="text-gray-200">|</span>
                    <Link href={`/ui/books/${book.id}`} className="text-blue-600 hover:text-blue-800 font-medium">
                      Edit
                    </Link>
                    <span className="text-gray-200">|</span>
